...
export const UPGRADE_CARDS = [
    {
        ...
        link:"facebook.com",
        btnTag:"Buy starter",
        describe: "Order for Starter",
        amount: "49000",
        sub1:[CheckIcon, "Database of 11M influencers"],
        sub2:[CheckIcon, "200 monthly results"],
        sub3:[CheckIcon, "20 monthly reports"],
    ...
    {   
        ...
        link:"facebook.com",
        btnTag:"Buy business",
        describe: "Order for Business",
        amount: "99000",
        sub1:[CheckIcon, 'Database of 11M influencers'],
        sub2:[CheckIcon, '1000 monthly results'],
    ...
    },
    {
        ...
        link:"facebook.com",
        btnTag:"Buy gold",
        describe: "Order for Gold",
        amount: "149000",
        sub1:[CheckIcon, 'Database of 11M influencers'],
        sub2:[CheckIcon, '3000 monthly results'],
        sub3:[CheckIcon, '1000 monthly reports'],
