    ...
    useEffect(() => {
        if (socket.current) {
            ...
            socket.current.on("msg-recieve", (msg) => {
                ...
                const senderInfo = msg.info.roleId == 2 ? { username: msg.info.fullNameClient, avatarImage: msg.info?.avatar } : { nickname: msg.info.nickName, avatarImage: msg.info?.avatar }
                setArrivalMessage({ fromSelf: false, message: msg.mess, isSenderInfluencer: isSenderInfluencer, senderInfo: senderInfo });
            });
        }
    }, [socket.current])
