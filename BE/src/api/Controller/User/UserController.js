...
async function register(req, res, next){
    try {
        ...
        existingEmail = userService.getUserByEmail(userModels.email);
        if (existingEmail){
...
async function confirm(req, res, next){
    try{
        ...
        if(otp === sendMail.otp){
            result = userService.insertInfoUser(userModels.id,userModels.email,userModels.password,userService.role);
            if(result){
    ...
    try{
        ...
        passport.authenticate("local", (err, user, info) => {
            ...
            req.logIn(user, (err) => {
                ...
                result = userService.insertSessionUser();
                if(true){
